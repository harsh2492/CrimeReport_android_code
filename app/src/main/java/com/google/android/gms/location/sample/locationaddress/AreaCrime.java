...
public class AreaCrime extends ListActivity {
...
*/
  ...
  private static String url_all_crimes = "http://192.168.1.5/Backend/get_crimes.php";
    */
    ...
    //Now i am using this
    private static String url_all_crimes = "http://192.168.1.4/Backend/get_crimelist.php";
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AreaCrime.this);
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    for (int i = 0; i < products.length(); i++) {
                        ...
                        String taddress = aa[1];

                        //did this
                        if(c.getString(TAG_ADDRESS).equals(taddress))
